  ...
  return (
    <div>
        ...
        <div className='absolute'>
            <img className='h-screen object-cover md:w-screen md:bg-gradient-to-b md:from-black' src={BACKDROP_IMG}  alt='bg-img'  />
        </div>
 
    <form onSubmit={(e)=>e.preventDefault()} className='w-full md:w-3/12  absolute  p-12 bg-black my-36 mx-auto right-0 left-0  rounded-lg bg-opacity-80 text-white'>
